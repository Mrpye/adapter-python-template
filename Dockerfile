...
#Update the below two lines to be your adapter name, not template_adapter
...
#Comment out the JAIL lines for faster compile, however this is a security issue
#Must uncomment for production running
