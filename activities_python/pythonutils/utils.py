...
#added from default template by shaurobe,kmccabe2,fdemello
#Added six libraries, and json functions
if six.PY2:
    import urlparse
else:
...
def recursively_make_json_dumpable(obj):
    if isinstance(obj, (list,set)):
        return [recursively_make_json_dumpable(o) for o in obj]
    elif isinstance(obj, dict):
        return {recursively_make_json_dumpable(k): recursively_make_json_dumpable(v) for k, v in obj.items()}
